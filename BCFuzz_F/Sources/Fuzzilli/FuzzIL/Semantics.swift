...
extension Operation {
    func isMatchingEnd(for beginOp: Operation) -> Bool {
        ...
        case .beginClassInstanceStringMethod,
        ...
        case .beginClassStaticStringMethod,
        ...
        case .beginExpressionBodyArrowFunction:
            return endOp is EndExpressionBodyArrowFunction
        ...
        case .beginTry:
            return endOp is BeginCatch || endOp is BeginCatchWithDestruct || endOp is BeginFinally
        case .beginCatch,
