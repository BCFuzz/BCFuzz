...
enum Opcode {
    ...
    case objectLiteralAddStringProperty(ObjectLiteralAddStringProperty)
    case objectLiteralAddNumericProperty(ObjectLiteralAddNumericProperty)
    ...
    case beginObjectLiteralStringMethod(BeginObjectLiteralStringMethod)
    case beginObjectLiteralNumericMethod(BeginObjectLiteralNumericMethod)
    case beginObjectLiteralComputedMethod(BeginObjectLiteralComputedMethod)
    case endObjectLiteralMethod(EndObjectLiteralMethod)
    case beginObjectLiteralStringGetter(BeginObjectLiteralStringGetter)
    case beginObjectLiteralComputedGetter(BeginObjectLiteralComputedGetter)
    case beginObjectLiteralNumericGetter(BeginObjectLiteralNumericGetter)
    case endObjectLiteralGetter(EndObjectLiteralGetter)
    case beginObjectLiteralStringSetter(BeginObjectLiteralStringSetter)
    case beginObjectLiteralComputedSetter(BeginObjectLiteralComputedSetter)
    case beginObjectLiteralNumericSetter(BeginObjectLiteralNumericSetter)
    ...
    case beginClassInstanceStringMethod(BeginClassInstanceStringMethod)
    case beginClassInstanceComputedMethod(BeginClassInstanceComputedMethod)
    case beginClassInstanceNumericMethod(BeginClassInstanceNumericMethod)
    case beginClassInstanceBigIntMethod(BeginClassInstanceBigIntMethod)
    case endClassInstanceMethod(EndClassInstanceMethod)
    case beginClassInstanceStringGetter(BeginClassInstanceStringGetter)
    case beginClassInstanceComputedGetter(BeginClassInstanceComputedGetter)
    case beginClassInstanceNumericGetter(BeginClassInstanceNumericGetter)
    case endClassInstanceGetter(EndClassInstanceGetter)
    case beginClassInstanceStringSetter(BeginClassInstanceStringSetter)
    case beginClassInstanceComputedSetter(BeginClassInstanceComputedSetter)
    case beginClassInstanceNumericSetter(BeginClassInstanceNumericSetter)
    ...
    case beginClassStaticStringMethod(BeginClassStaticStringMethod)
    case beginClassStaticComputedMethod(BeginClassStaticComputedMethod)
    case beginClassStaticNumericMethod(BeginClassStaticNumericMethod)
    case beginClassStaticBigIntMethod(BeginClassStaticBigIntMethod)
    case endClassStaticMethod(EndClassStaticMethod)
    case beginClassStaticStringGetter(BeginClassStaticStringGetter)
    case beginClassStaticComputedGetter(BeginClassStaticComputedGetter)
    case beginClassStaticNumericGetter(BeginClassStaticNumericGetter)
    case endClassStaticGetter(EndClassStaticGetter)
    case beginClassStaticStringSetter(BeginClassStaticStringSetter)
    case beginClassStaticComputedSetter(BeginClassStaticComputedSetter)
    case beginClassStaticNumericSetter(BeginClassStaticNumericSetter)
    case endClassStaticSetter(EndClassStaticSetter)
    case classAddPrivateInstanceProperty(ClassAddPrivateInstanceProperty)
    case classAddPrivateInstancePropertyWithPrivateInInitializer(ClassAddPrivateInstancePropertyWithPrivateInInitializer)
    ...
    case classAddPrivateStaticPropertyWithPrivateInInitializer(ClassAddPrivateStaticPropertyWithPrivateInInitializer)
    ...
    case testIn(TestIn)
    case testClassPrivateInInMethod(TestClassPrivateInInMethod)
    ...
    case beginExpressionBodyArrowFunction(BeginExpressionBodyArrowFunction)
    case endExpressionBodyArrowFunction(EndExpressionBodyArrowFunction)
    ...
    case beginCatchWithDestruct(BeginCatchWithDestruct)
