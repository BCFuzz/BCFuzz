...
void __attribute__((weak)) __sanitizer_cov_trace_pc_guard(uint32_t *guard, int bbflag) {
...
void __attribute__((weak)) __sanitizer_cov_trace_pc_guard_init(uint32_t *start, uint32_t *stop) {
